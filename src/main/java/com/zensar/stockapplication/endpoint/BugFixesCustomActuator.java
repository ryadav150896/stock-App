...
public class BugFixesCustomActuator {
	...
	@PostConstruct
	public void init() {
		bugFixesByVersionMap.put("v1", Arrays.asList("Invalid status", "Application closing not working"));
	...
	@WriteOperation
	Map<String, List<String>> addBugFixes(@Selector String version, String bugFixes) {
